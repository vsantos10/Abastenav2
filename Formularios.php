	...
	<div class="page-content">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue">
								...
								<div class="details">
									...
									<div class="desc">
										 Vistoria Planeamento
									</div>
								</div>
								<a class="more" href="VistoriaPlaneamento.php">
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue">
								...
								<a class="more" href="vistoriaoperacional.php">
								Ver <i class="m-icon-swapright m-icon-white"></i>
								</a>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue">
								...
								<div class="details">
									...
									<div class="desc">
										 Inquérito Membro BFA
									</div>
								</div>
								<a class="more" href="inqueritomembrobfa.php">
								Ver <i class="m-icon-swapright m-icon-white"></i>
								</a>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue">
								...
								<div class="details">
									...
									<div class="desc">
										 Caracterização da Mata
									</div>
								</div>
								<a class="more" href="caracterizacaomata.php">
								Ver <i class="m-icon-swapright m-icon-white"></i>
								</a>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="dashboard-stat blue">
							...
							<a class="more" href="listainformacao.php">
							Ver <i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
					</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue">
						...
						<a class="more" href="comunicacaodeoperacao.php">
						Ver <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat blue">
					...
					<a class="more" href="comunicacaoaplicacao.php">
					Ver <i class="m-icon-swapright m-icon-white"></i>
					</a>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="dashboard-stat blue">
				...
				<a class="more" href="acordodecontratacao.php">
				Ver <i class="m-icon-swapright m-icon-white"></i>
				</a>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="dashboard-stat blue">
				...
				<a class="more" href="declaracaocompromisso.php">
				Ver <i class="m-icon-swapright m-icon-white"></i>
				</a>
			</div>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="dashboard-stat blue">
				...
				<a class="more" href="declaracaofornecimento.php">
				Ver <i class="m-icon-swapright m-icon-white"></i>
				</a>
			</div>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="dashboard-stat blue">
				...
				<a class="more" href="delegacaoresponsabilidade.php">
				Ver <i class="m-icon-swapright m-icon-white"></i>
				</a>
			</div>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="dashboard-stat blue">
				...
				<div class="details">
					...
					<div class="desc">
						 Lista de Informação BFA
					</div>
				</div>
				<a class="more" href="listainformacaobfa.php">
				Ver <i class="m-icon-swapright m-icon-white"></i>
				</a>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="dashboard-stat blue">
				...
				<a class="more" href="fichatratamento.php">
				Ver <i class="m-icon-swapright m-icon-white"></i>
				</a>
			</div>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="dashboard-stat blue">
				...
				<div class="details">
					...
					<div class="desc">
						 Declaração de Compromisso BFA
					</div>
				</div>
				<a class="more" href="declaracaocomprimisobfa.php">
				Ver <i class="m-icon-swapright m-icon-white"></i>
				</a>
			</div>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="dashboard-stat blue">
				...
				<a class="more" href="inqueritomata.php">
				Ver <i class="m-icon-swapright m-icon-white"></i>
				</a>
			</div>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="dashboard-stat blue">
				...
				<div class="details">
					...
					<div class="desc">
						 Compromisso de Negocio
					</div>
				</div>
				<a class="more" href="compromissonegocio.php">
				Ver <i class="m-icon-swapright m-icon-white"></i>
				</a>
			</div>
		</div>
